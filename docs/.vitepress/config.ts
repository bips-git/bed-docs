...
export default defineConfig({
  ...
  locales: {
    ...
    bn: {
      ...
      lang: 'bn',
      link: '/bn/',
      title: 'বি.এড. অধ্যয়ন সামগ্রী',
      themeConfig: {
        outline: { level: [2, 3], label: 'এই পাতায়' },
        docFooter: { prev: 'পূর্ববর্তী পাতা', next: 'পরবর্তী পাতা' },
        darkModeSwitchLabel: 'থিম',
        returnToTopLabel: 'উপরে যান',
        ...
        sidebar: {
          '/bn/gender-school-society/': [{
            text: 'লিঙ্গ, বিদ্যালয় ও সমাজ',
            items: [
              { text: 'প্রথম একক: প্রধান প্রসঙ্গসমূহ', link: '/bn/gender-school-society/unit-1-key-concerns' },
              { text: 'দ্বিতীয় একক: লিঙ্গ-অধ্যয়ন- দৃষ্টান্ত পরিবর্তন', link: '/bn/gender-school-society/unit-2-paradigm-shifts' },
